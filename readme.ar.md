...
```
عرف هات_صحيح(مفتاح: مؤشر[مصفوفة[محرف]]): صحيح؛
```
...
الوظيفة هذه بنسختيها تقوم باستدعاء النسخة المناسبة من الوظيفة `هات` ولكن ترجع القيمة بعد تحويلها إلى النمط `صحيح`.
...
```
عرف هات_عائم(مفتاح: مؤشر[مصفوفة[محرف]]): عائم؛
```
...
الوظيفة هذه بنسختيها تقوم باستدعاء النسخة المناسبة من الوظيفة `هات` ولكن ترجع القيمة بعد تحويلها إلى النمط `عائم`.
